...
#define TRIGGERBOT_WINDOW 4 // within 5 pixels radius of the crosshair
...
#define SS_PER_SEC 400 // how many ss to take per sec
...
const float BLUE_DOMINANCE_THRES[] = { 0.8, 1.0 };